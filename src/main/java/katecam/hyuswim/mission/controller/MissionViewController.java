...
public class MissionViewController {
    ...
    public MissionViewController(MissionQueryService missionQueryService, MissionService missionService) {
    ...
    public String list(Model model) {
        ...
        boolean hasPickedToday = list.stream().anyMatch(
                m -> m.state == TodayState.IN_PROGRESS || m.state == TodayState.COMPLETED);
